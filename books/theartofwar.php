...
<section class="playlist-details">
   ...
   <div class="row">
      ...
      <div class="column">
         ...
         <div class="thumb">
            <img src="https://cdn.kobo.com/book-images/fc4a354b-27cd-4b29-8966-26fafb527c94/1200/1200/False/the-art-of-war-deluxe-hardbound-edition.jpg" alt="IKIGAI">
         </div>
      </div>
      <div class="column">
         <div class="tutor">
         ...
         <div class="details">
            <h3 style="margin-top: -400px; margin-left: -200px; font-size: 100px;">The Art Of War  </h3>
           
            <h4 style="font-size: 40px; margin-left: -190px; "> Sun Tzu</h4>
            <p style="margin-top: 10px; margin-left: -190px;">The Art of War applies to competition and conflict in general, on every level from the interpersonal to the international. Its aim is invincibility, victory without battle, and unassailable strength through understanding the physics, politics, and psychology of conflict.</p>
