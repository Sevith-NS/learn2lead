...
<section class="playlist-details">
   ...
   <div class="row">
      ...
      <div class="column">
         ...
         <div class="thumb">
            <img src="https://m.media-amazon.com/images/I/813aV273-rL._AC_UF1000,1000_QL80_.jpg" alt="It ends with us">
         </div>
      </div>
      <div class="column">
         <div class="tutor">
         ...
         <div class="details">
            <h3 style="margin-top: -400px; margin-left: -200px; font-size: 100px;">It Ends With Us </h3>
           
            <h4 style="font-size: 40px; margin-left: -195px; ">Colleen Hoover</h4>
            <p style="margin-top: 10px; margin-left: -190px;">The novel tells the story of Lily Bloom, a young woman from an abusive home who struggles to find her way in the world without recreating the patterns of violence from her youth. Moving between Lily's present and diary entries from her adolescence, the novel explores the complex nexus of love and abuse.</p>
